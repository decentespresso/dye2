...
Beans/grinders are real, typed bridge resources. Auto-favourites, recipes,
(for now) filter baskets, and equipment have no bridge resource of their own
and are instead persisted through the bridge's generic, **unscoped**
